package eu.aeiounce.clj_superapp;
...
import eu.aeiounce.clj_superapp.R;
...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("eu.aeiounce.clj_superapp.MyActivity",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("eu.aeiounce.clj_superapp.MAIN"));
        finish();
    }
